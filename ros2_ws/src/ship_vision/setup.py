...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name),
            ['ship_vision/yolo_detection_node.py']),
    ],
    install_requires=['setuptools'],
    zip_safe=True,
    maintainer='linzhensheng',
    maintainer_email='youngbillionairesid@gmail.com',
    description='Vision pipeline — YOLO detection, pixel-to-angle, debug dashboards',
    ...
    entry_points={
        'console_scripts': [
            ...
            # ── NEW ──────────────────────────────────────────────────
            'imu_dashboard_node   = ship_vision.imu_dashboard_node:main',
        ],
    },
)